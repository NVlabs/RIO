...
_PREDEFINED_SPLITS_LVIS = {
    ...
    "lvis_v1_head": {
        "lvis_v1_train_head": ("coco/", "lvis/lvis_v1_train_headv2.json"),
        "lvis_v1_val_head": ("coco/", "lvis/lvis_v1_val_headv2.json"),
    },
    "lvis_v0.5_head": {
        "lvis_v0.5_train_head": ("coco/", "lvis/lvis_v0.5_train_headv2.json"),
        "lvis_v0.5_val_head": ("coco/", "lvis/lvis_v0.5_val_headv2.json"),
    },
    "lvis_v0.5": {
