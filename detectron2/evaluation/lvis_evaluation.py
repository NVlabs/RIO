...
class LVISEvaluator(DatasetEvaluator):
    ...
    def process(self, inputs, outputs):
        ...
        for input, output in zip(inputs, outputs):
            ...
            #     "cls_scores": outputs[0]["instances"]
            #     .get_fields()["all_cls_scores"]
            #     .tolist(),
            # }
            # self.all_cls_scores.append(cls_scores)
            # outputs[0]["instances"].remove("all_cls_scores")
            # pdb.set_trace()
    ...
    def evaluate(self):
        ...
        if self._output_dir:
            ...
            # file_path = os.path.join(self._output_dir, "instances_all_cls_scores.pth")
            # with PathManager.open(file_path, "wb") as f:
            #     torch.save(self.all_cls_scores, f)
