...
def fast_rcnn_inference_single_image(
    ...
    # pdb.set_trace()
    final_bbox_all_scores = original_scores[filter_inds[:, 0]]

    # filter_inds[:, 0]
    # contains the index of bboxes that passed
    # filter_inds[:, 1]
    # contains the index of highest cls score for corresponding bbox
    return (
        result,
        filter_inds[:, 0],
    )  # final_bbox_all_scores
